...
export default createClass({
  ...
  componentDidMount() {
    this.setState({
      ...
      rootElemWidth:
        this.root.clientWidth || this.root.offsetWidth || this.root.scrollWidth,
      rootElemHeight:
  ...
  render() {
    return (
      <div
        ...
        onMouseMove={
          !this.props.isStatic ? this.handleMove : this.handleStaticEvent
        }
        onMouseEnter={
          !this.props.isStatic ? this.handleEnter : this.handleStaticEvent
        }
        onMouseLeave={
          !this.props.isStatic ? this.handleLeave : this.handleStaticEvent
        }
        onTouchMove={
          !this.props.isStatic ? this.handleTouchMove : this.handleStaticEvent
        }
        onTouchStart={
          !this.props.isStatic ? this.handleEnter : this.handleStaticEvent
        }
